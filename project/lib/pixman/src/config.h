...
#if defined(HX_WINDOWS) || defined(HX_MACOS) || (defined(HX_LINUX) && !defined(RASPBERRYPI) && !defined(HXCPP_ARM64))
#define USE_SSE2 1
#else
/* #undef USE_SSE2 */
#endif
...
#if (defined(HX_WINDOWS) || /*defined(HX_MACOS) ||*/ (defined(HX_LINUX) && !defined(RASPBERRYPI)) && !defined(HXCPP_ARM64)) && !defined(HXCPP_M64)
